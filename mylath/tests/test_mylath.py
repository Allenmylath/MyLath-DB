# tests/test_mylath.py
"""
Complete integration test for MyLath functionality
"""
import pytest
...
def test_mylath():
    ...
    # Initialize storage and graph (use separate DB for testing)
    storage = RedisStorage(db=14)
    storage.redis.flushdb()  # Clear test database
    graph = Graph(storage)
